...
func (c *Camera) FollowTarget(targetX, targetY, screenWidth, screenHeight float64) {
	...
	c.Y = -targetY + screenHeight/2.0 // focuses the character into the middle of the screen.
}

func (c *Camera) ConstrainCamera(tilemapWidthPixels, tilemapHeightPixels, screenWidth, screenHeight float64) {
